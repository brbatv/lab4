...
linreg<-setRefClass("linreg",
                    fields=list(formula="formula",data="data.frame",beta_hat="numeric",res="numeric",fitted="numeric",name_of_data_input="character",df="numeric",reg_var="numeric",t_values="numeric",p_value="numeric"),
                    methods=list(
